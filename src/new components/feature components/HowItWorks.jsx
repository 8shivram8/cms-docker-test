  ...
  return (
    <Container maxWidth="lg">
      <Grid container spacing={1}>
        ...
        <Grid item xs={12}>
        <Box display="flex" justifyContent="center" alignItems="center" width="100%" border={'1px solid black'} >
            <Box display="flex" width="88%" sx={{ minHeight: "150px" }} mt={2} >
              <Box p={2} flex={1} textAlign="left" sx={{ pr: 2 }}>
